...
> 当前决策（ADR-0008）：本文的分类证据仍有效，但社区聚合源的现行语义已经收口：Hacker News/Lobsters 是其社区条目的一手来源，不是外链正文的发现—晋升入口。机构新闻与深度档案实行单一主去向。
...
3. **社交观点／社区**：个人 X 帖子，以及 Hacker News、Lobsters 等讨论。社区平台是自身条目、排序和讨论状态的一手来源，适合支持“社区正在讨论什么”；点赞、排序和外链转述不能证明外链事实，系统也不沿外链递归抓取。
