...
const lines = [
  "# OPC 服务台完整服务目录",
  "",
  `> 数据来源：\`data/defaults/opc-catalog.seed.json\` 的首版 SKU 默认目录。当前目录修订号：${state.sourceRevision ?? "未填写"}；发布时间：${state.publishedAt ?? "未发布，当前为预览目录"}。`,
  ...
  `- 定价现状：21 项服务均已填写人民币首版建议价，正式发布前可由运营人员调整。`,
