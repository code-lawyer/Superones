...
const requiredByFile = new Map([
  ...
  ["docs/Vault2077-Launch-Checklist.md", ["Frontier 境内 GitHub 快速路径", "Follow Builders X", "workflow 仍成功结束", "频道编辑配置", "真实上线基线", "真实 OSS", "无引用对象清理"]],
  ...
  ["docs/adr/0008-single-destination-content-routing.md", ["单一主去向", "ADR-0017", "Follow Builders"]],
