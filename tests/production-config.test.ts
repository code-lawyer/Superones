...
function validEnvironment() {
  ...
  return {
    ...
    VAULT2077_ESIGN_APP_SECRET: "esign-production-test-secret",
    VAULT2077_ESIGN_API_BASE_URL: "https://openapi.esign.cn",
    VAULT2077_ESIGN_INDIVIDUAL_TEMPLATE_ID: "tpl-individual-v1",
    VAULT2077_ESIGN_ORGANIZATION_TEMPLATE_ID: "tpl-organization-v1",
    VAULT2077_ESIGN_TEMPLATE_VERSION: "2026-08-02",
    VAULT2077_ESIGN_PROVIDER_SEAL_ID: "seal-production-test",
    ...
    VAULT2077_OPC_CONTRACT_ARCHIVE_STORAGE: "oss",
    VAULT2077_OPC_CONTRACT_OSS_REGION: "oss-cn-shanghai",
    VAULT2077_OPC_CONTRACT_OSS_BUCKET: "vault2077-private-opc-contracts",
    VAULT2077_OPC_CONTRACT_OSS_ACCESS_KEY_ID: "LTAI5tPrivateContractKey",
    VAULT2077_OPC_CONTRACT_OSS_ACCESS_KEY_SECRET: "private-contract-secret-key",
    VAULT2077_OPC_CONTRACT_OSS_INTERNAL: "true",
    VAULT2077_OPC_CONTRACT_RETENTION_YEARS: "10",
    VAULT2077_OPC_CONTRACT_RETENTION_LOCKED: "true",
